/**
 * The `Invoice` component in this code fetches user and item data, displays a list of items for
 * checkout, calculates the total amount, and generates an invoice for the user.
 * @returns The `Invoice` component is being returned. It is a functional component in React that
 * displays invoice details for a user. The component fetches user data and items data from an API
 * using Axios, calculates the total amount for the items in the checkout, and displays the invoice
 * details in a table format. The invoice includes user information, item details, subtotal, discount,
 * and total amount.
 */
