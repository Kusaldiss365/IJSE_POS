/**
 * The `AdminItems` function in this code is responsible for managing items in an admin interface,
 * including displaying, editing, and deleting items.
 * @returns The `AdminItems` component is being returned. It consists of JSX elements that render an
 * admin dashboard for managing items. The component includes an admin navigation bar, a section for
 * displaying items with options to add, edit, and delete items. It fetches data for categories,
 * stocks, and items from API endpoints and handles CRUD operations for items. The component also
