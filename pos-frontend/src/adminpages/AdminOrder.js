/**
 * The AdminOrder component in this code fetches and displays a list of checkouts, allows for deleting
 * checkouts, and shows detailed information about selected checkouts.
 * @returns The `AdminOrder` component is being returned. It contains JSX elements for displaying a
 * list of checkouts, details of selected cart items, and a table of checkouts with options to delete.
 * The component also includes functions for fetching checkouts, grouping them by cart ID, and deleting
 * a checkout.
 */
